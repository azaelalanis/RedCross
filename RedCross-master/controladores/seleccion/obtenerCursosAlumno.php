...
$sql="SELECT ins.id_alumno,cu.id_curso, cu.cu_nombre , cu.cu_dias, cu.cu_horaInicio, cu.cu_horaFinal, cu.cu_aula  FROM inscritos ins, curso cu where ins.id_alumno = $idAlumno order by cu.id_curso";
